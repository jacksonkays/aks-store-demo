...
#   provider = azurerm.secondary
#   count               = local.deploy_observability_tools ? 1 : 0
#   name                = "MSProm-${data.azurerm_kubernetes_cluster.example.location}-${data.azurerm_kubernetes_cluster.example.name}-${random_integer.example.result}"
...
#   provider = azurerm.secondary
#   count                   = local.deploy_observability_tools ? 1 : 0
#   name                    = "dcr-${data.azurerm_kubernetes_cluster.example.name}-${random_integer.example.result}"
...
#   provider = azurerm.secondary
#   count               = local.deploy_observability_tools ? 1 : 0
#   name                = "NodeRecordingRulesRuleGroup-${data.azurerm_kubernetes_cluster.example.name}-${random_integer.example.result}"
#   resource_group_name = data.azurerm_kubernetes_cluster.example.resource_group_name
#   location            = data.azurerm_kubernetes_cluster.example.location
...
#   count               = local.deploy_observability_tools ? 1 : 0
#   name                = "KubernetesRecordingRulesRuleGroup-${data.azurerm_kubernetes_cluster.example.name}-${random_integer.example.result}"
#   resource_group_name = data.azurerm_kubernetes_cluster.example.resource_group_name
#   location            = data.azurerm_kubernetes_cluster.example.location
#   cluster_name        = data.azurerm_kubernetes_cluster.example.name
#   rule_group_enabled  = true
...
#   count               = local.deploy_observability_tools ? 1 : 0
#   name                = "MSCI-${data.azurerm_kubernetes_cluster.example.location}-${data.azurerm_kubernetes_cluster.example.name}-${random_integer.example.result}"
#   resource_group_name = data.azurerm_kubernetes_cluster.example.resource_group_name
#   location            = data.azurerm_kubernetes_cluster.example.location
#   kind                = "Linux"
...
#   count                   = local.deploy_observability_tools ? 1 : 0
#   name                    = "msci-${data.azurerm_kubernetes_cluster.example.name}-${random_integer.example.result}"
#   target_resource_id      = data.azurerm_kubernetes_cluster.example.id
